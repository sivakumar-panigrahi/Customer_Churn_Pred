...
from data.load_data import load_data        # ✅ works with this fix
from data.preprocess import preprocess_data # ✅
from features.build_features import build_features # ✅


# === CONFIG ===
# Define project root dynamically (already matches sys.path logic above)
project_root = os.path.abspath(os.path.join(os.path.dirname(__file__), ".."))

DATA_PATH  = os.path.join(project_root, "WA_Fn-UseC_-Telco-Customer-Churn.csv")
TARGET_COL = "Churn"
